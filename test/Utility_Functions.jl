function populateMemory(act=0.0)
    ...
    push!(chunks, Chunk(object=:shark, attribute=:locomotion, value=:swimming, act=act))
    ...
    push!(chunks, Chunk(object=:salmon, attribute=:locomotion, value=:swimming, act=act))
    ...
    push!(chunks, Chunk(object=:fish, attribute=:locomotion, value=:swimming, act=act))
    ...
    push!(chunks, Chunk(object=:ostritch, attribute=:category, value=:bird, act=act))
    push!(chunks, Chunk(object=:bird, attribute=:wings, value=:True, act=act))
    push!(chunks, Chunk(object=:bird, attribute=:locomotion, value=:flying, act=act))
